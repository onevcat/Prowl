...
| 052 | [agent-account-switching](052-agent-account-switching/000-plan.md) | 2026-07-27 | Per-repository Claude Code / Codex accounts: CLAUDE_CONFIG_DIR / CODEX_HOME, login status, shared user configuration |
