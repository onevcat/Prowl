...
| Remote Mirror | `supacode/Features/RemoteMirror/RemoteMirrorPaneView.swift` | Navigation Host button, principal connection summary without a shared background, primary action group for recovery, options and disconnect. | Native window toolbar; display size and history are in the options menu. |
